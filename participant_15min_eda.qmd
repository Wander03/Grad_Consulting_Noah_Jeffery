...
full_data %>%
  ...
  ggplot(aes(x = normalized_angle_x, y = participant_number, fill = ..x..)) +
    ...
    labs(title = 'Distribution of Time Spent in Normalized Angle X by Participant', subtitle = 'Device 1') +
    theme_ipsum() +
      theme(
        legend.position="none",
        panel.spacing = unit(0.1, "lines"),
...
full_data %>%
  ...
  ggplot(aes(x = normalized_angle_x, y = participant_number, fill = ..x..)) +
    geom_density_ridges_gradient(scale = 3, rel_min_height = 0.01) +
    scale_fill_viridis(name = "angle_x", option = "C") +
    labs(title = 'Distribution of Time Spent in Normalized Angle X by Participant', subtitle = 'Device 2') +
    theme_ipsum() +
      theme(
        legend.position="none",
        panel.spacing = unit(0.1, "lines"),
...
full_data %>%
  ...
  ggplot(aes(x = normalized_angle_x, y = participant_number, fill = ..x..)) +
    geom_density_ridges_gradient(scale = 3, rel_min_height = 0.01) +
    scale_fill_viridis(name = "angle_x", option = "C") +
    labs(title = 'Distribution of Time Spent in Normalized Angle X by Participant', subtitle = 'Device 3') +
    theme_ipsum() +
      theme(
        legend.position="none",
        panel.spacing = unit(0.1, "lines"),
